...
parser = argparse.ArgumentParser(description="Freezes project requirements.")
parser.add_argument(
    "--config", help="Config file path", default="~/.pipfreezer/pipfreezer.cfg"
)
# parser.add_argument('-p,', '--password', help='SFTP Password')
parser.add_argument(
    "-s", "--sub", action="store_true", help="Output sub-dependencies to a file"
)
