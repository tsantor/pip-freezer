...
setup(
    ...
    download_url='https://bitbucket.org/tsantor/pip-freezer.git@%s.tar.gz' % __version__,
    ...
    keywords='pip-freezer, pipfreezer',
    ...
    entry_points={
        'console_scripts': [
            'pip-freezer = pipfreezer.pipfreezer:run',
        ],
    },
